...
| doc-ver-api.image.tag | string | `"3.11.1"` | deployment docker image tag, if not set, version will be used as tag |
...
| docver-runner.image.tag | string | `"3.11.1"` | deployment docker image tag, if not set, version will be used as tag |
